...
internal class Artist : RoleBase
{
     ...
     public override void SetupCustomOption()
    {
        ...
        KillCooldown = FloatOptionItem.Create(Id + 10, GeneralOption.KillCooldown, new(0f, 180f, 2.5f), 30f, TabGroup.CrewmateRoles, false).SetParent(CustomRoleSpawnChances[CustomRoles.Artist])
            .SetValueFormat(OptionFormat.Seconds);
        PaintCooldown = FloatOptionItem.Create(Id + 11, GeneralOption.PaintCooldown, new(0f, 180f, 2.5f), 5f, TabGroup.CrewmateRoles, false).SetParent(CustomRoleSpawnChances[CustomRoles.Artist])
            .SetValueFormat(OptionFormat.Seconds);
        HideNameOfPaintedPlayer = BooleanOptionItem.Create(Id + 12, "ArtistHideNamePainted", true, TabGroup.CrewmateRoles, false).SetParent(CustomRoleSpawnChances[CustomRoles.Artist]);
